...
class RoomsController {
    ...
    async deleteRoom(req, res) {
        ...
        try {
            ...
            return res.json({success: 'Xóa phòng thành công! Các tài khoản và phân phối sách thuộc phòng này sẽ được chuyển thành "Không xác định"'});
        } catch (error) {
            return res.json({error: 'Đã xảy ra lỗi khi xóa phòng. Vui lòng thử lại sau.'})
        }
    };
}
