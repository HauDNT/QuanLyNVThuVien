...
class BooksController {
  ...
  async createCataloging(req, res) {
    ...
    if (!catalogingInfo) {
      res.json({
        error:
          "Không thể tạo biên mục. Hãy kiểm tra lại thông tin và thử lại sau!",
      });
      return;
    }
  ...
  async updateCataloging(req, res) {
    ...
    if (!catalogingInfo) {
      res.json({
        error:
          "Không thể cập nhật biên mục. Hãy kiểm tra lại thông tin và thử lại sau!",
      });
      return;
    }
  ...
  async deleteCataloging(req, res) {
    ...
    if (!catalogingInfo) {
      res.json({
        error:
          "Không thể xóa biên mục. Hãy kiểm tra lại thông tin và thử lại sau!",
      });
      return;
    }
