...
const StoreTypesProvider = ({children}) => {
    ...
    const removeStoreType = (storeTypeDeleteId) => {
        setStoreTypes(prevList => prevList.filter(storeType => storeType.id !== storeTypeDeleteId));
    };
    ...
    return (
        <StoreTypesContext.Provider value={{storeTypes, updateStoreType, removeStoreType}}>
            {children}
