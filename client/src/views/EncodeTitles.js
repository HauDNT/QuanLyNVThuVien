...
function EncodeTitles() {
  ...
  const handleDeleteEncodeTitle = (numberEncrypt) => {
    axios
      .delete(`http://${config.URL}/encodeTitles/delete/${numberEncrypt}`, {
        headers: { authenToken: localStorage.getItem("authenToken") },
      })
      .then((res) => {
        if (res.data.success) {
          ...
          setEncodeTitles((prev) =>
            prev.filter((item) => item.NumberEncrypt !== numberEncrypt),
    ...
    <>
      ...
      <div className="row">
        <div className="col-lg-12">
                  ...
                  <tr key={item.NumberEncrypt} className="text-center">
                    ...
                    <td>
                      ...
                      isEdit.status === true ? (
                        <button
                          ...
                          onClick={(e) =>
                            handleUpdateValues(item.NumberEncrypt)
                          }
                        >
                        ...
                        <button
                          ...
                          value={item.NumberEncrypt}
                          onClick={() =>
                            handleClickToUpdate(item.NumberEncrypt)
                          }
                        >
                    ...
                    <td>
                      <button
                        ...
                        value={item.NumberEncrypt}
                        onClick={() =>
                          handleDeleteEncodeTitle(item.NumberEncrypt)
                        }
                      >
          ...
          <Paginate data={encodeTitles} applyPaginateData={applyPaginate} />
        </div>
      </div>
    </>
  );
