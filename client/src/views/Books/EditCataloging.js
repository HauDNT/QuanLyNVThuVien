...
function EditCataloging() {
    ...
    useEffect(() => {
        if (infoCataloging && infoCataloging.UserId && statusLoadName) {
            axios
                .get(
                    `http://${config.URL}/users/fullname/${infoCataloging.UserId}`
                )
                .then((res) => {
    ...
    return (
        <>
            <div className="form-container">
                <h1 className="form-header">Biên mục</h1>
                        ...
                        <div className="col-md-12 col-sm-12">
                            <div class="input-group">
                                ...
                                <input
                                    ...
                                    className="form-control"
                                    placeholder="Load họ tên user vào trường input này"
                                    value={formatAndDisplayDatetime(
                                        infoCataloging.createdAt
                                    )}
                                    readOnly
                                    required
                                />
                            ...
                            <div class="input-group">
                                ...
                                <input
                                    ...
                                    value={
                                        ...
                                        infoCataloging.BooksRegisInfos.length >
                                            1
                                            ? infoCataloging.BooksRegisInfos[1]
                                                  .Status === true
                                                ? 'Đã duyệt'
                                                : 'Chưa duyệt'
                                            : 'Chưa duyệt'
                            ...
                            <div className="row">
                                <div className="col-md-1 col-sm-12">
                                    <button
                                        ...
                                        className="btn btn-back w-100 mb-3"
                                        type="button"
                                    >
                                        Quay về
                                    </button>
                                ...
                                <div className="col-md-4 col-sm-12">
                                    <div className="row">
                                        <div className="col-md-3 col-sm-12">
                                            ...
                                            (idRole === 1 || idRole === 2) ? (
                                                <button
                                                    ...
                                                    type="button"
                                                    className="btn btn-success mb-3 w-100 mb-3"
                                                >
                                                    Duyệt
                                                </button>
                                            ) : (
                                        ...
                                        <div className="col-md-3 col-sm-12">
                                            <button
                                                onClick={(e) =>
                                                    handleDeleteCataloging()
                                                }
                                                type="button"
                                                className="btn btn-danger mb-3 w-100 mb-3"
                                            >
                                                Xóa
                                            </button>
                                        </div>
                                        <div className="col-md-3 col-sm-12">
                                            <button
                                                onClick={(e) =>
                                                    handleUpdateCataloging()
                                                }
                                                type="button"
                                                className="btn btn-primary mb-3 w-100 mb-3"
                                            >
                                                Cập nhật
                                            </button>
                                        </div>
