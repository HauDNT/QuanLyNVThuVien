...
function CreateCataloging() {
  ...
  return (
    <div className="createCataloging-container">
      ...
      <div class="row input-file mb-3"></div>
      <form
        method="POST"
      ...
      >
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, ISBN: e.target.value })
            }
            type="number"
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, DDC: e.target.value })
            }
            type="number"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, EncryptName: e.target.value })
            }
            type="text"
            className="form-control"
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, MainTitle: e.target.value })
            }
            type="text"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, Types: e.target.value })
            }
            type="text"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, OrtherAuthors: e.target.value })
            }
            type="text"
            className="form-control"
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, Editors: e.target.value })
            }
            type="text"
            className="form-control"
        ...
        <div class="mb-3">
          ...
          <textarea
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, Synopsis: e.target.value })
            }
            rows="3"
          />
        </div>
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, Publisher: e.target.value })
            }
            type="text"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, PubPlace: e.target.value })
            }
            type="text"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, PubYear: e.target.value })
            }
            type="number"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, QuantityCopies: e.target.value })
            }
            type="number"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, NumPages: e.target.value })
            }
            type="number"
            className="form-control"
          />
        ...
        <div class="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, UnitPrice: e.target.value })
            }
            type="number"
            className="form-control"
          />
