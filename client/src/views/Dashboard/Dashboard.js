            ...
            {isLoading ? (
                ...
                <div className="dashboard">
                    ...
                    <div className="row chart-container">
                        <div className="col-md-7 col-sm-12 chart-item">
                            <select
                            ...
                            <Chart_CatalogPerMonth
                                className="mb-3"
                                props={catalogPerMonth}
                                year={year}
                            />
                        </div>
                        <div className="col-md-4 col-12 chart-item chart-doughnut">
                    ...
                    <div className="row chart-container">
                        <div className="col-md-12 col-sm-12 chart-item">
                            <select
                                class="form-select chart-time text-center"
                                name="month"
                                value={month}
