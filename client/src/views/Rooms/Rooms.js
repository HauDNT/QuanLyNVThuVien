...
function Rooms() {
    ...
    const deleteRoom = (roomId) => {
        axios
            .delete(
                `http://${config.URL}/rooms/deleteRoom/${roomId}`,
                { headers: {
                    authenToken: localStorage.getItem('authenToken')
                }}
            )
            ...
            <div className="row">
                ...
                >
                    {({ values, setFieldValue }) => (
                        <Form className="col-5 form-add-type">
                            <div className="mb-3">
                                <h5 className="form-label mb-3 text-center">Thêm phòng ban mới</h5>
                ...
                <div className="col-7">
                    <table className="styled-table table--bill-types">
                        <thead>
                            <tr>
                                <th scope="col" className="text-center"> Mã phòng </th>
                                <th scope="col" className="text-center"> Tên phòng </th>
