...
function CreateBarCode() {    
    ...
    const findListRegisCodes = (firstCode, lastCode) => {
        ...
        if (firstCode !== lastCode) {
            ...
            let strZero = '';
            for (let i = 1; i <= firstCode.split('.')[1].length; i++)    // Tạo 1 dãy các số 0 để format lại mã đăng ký trong thao tác phía dưới
    ...
    const sendRegisCode_ReceiveBarCode = () => {
        if (listCode.length > 0) {
            axios
            .post(`http://${config.URL}/barcode/generate/`, listCode, {headers: {authenToken: localStorage.getItem('authenToken')}})
            .then((res) => {
                if (!res.data.error) {
            ...
            toast.error('Bạn phải điền đầy đủ thông tin!');
    };
                    ...
                    <div class="form-group">
                        <div className="row">
                            ...
                            <div className="col-4 btn-container">
                                <button type="button"class="btn btn-primary" onClick={sendRegisCode_ReceiveBarCode}>Tạo mã</button>
                            ...
                            <div className="col-lg-3">
                                <div className="card mb-3">
                                    <div className="card-body text-center">
                                        ...
                                        <h6 class="card-title mb-2">{item.EncryptName}</h6>
                                        <Barcode 
