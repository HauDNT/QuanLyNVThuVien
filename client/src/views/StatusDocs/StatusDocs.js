...
function StatusDocs() {
    ...
    const addStatusDoc = (values) => {
        axios
            .post(
                `http://${config.URL}/statusdocs/addStatusDoc`, 
                values, 
                { headers: {
            ...
            .catch(error => {
                toast.error("Đã xảy ra lỗi trong quá trình tạo trạng thái tài liệu mới!", error);
            });
    };
            ...
            <div className="row">
                ...
                >
                    {({ values, setFieldValue }) => (
                        <Form className="col-5 form-add-type">
                            <div className="mb-3">
                                <h5 className="form-label mb-3 text-center">Thêm trạng thái tài liệu mới</h5>
                ...
                <div className="col-7">
                    <table className="styled-table table--bill-types">
                        <thead>
                            <tr>
                                <th scope="col" className="text-center"> Mã trạng thái </th>
                                <th scope="col" className="text-center"> Tên trạng thái </th>
